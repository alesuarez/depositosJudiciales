...
public class SelectorDeposito extends javax.swing.JFrame {
    ...
    public SelectorDeposito() {
        ...
        for (Deposito deposito : depositoController.getDepositos()) {
            modelo.addElement(deposito.getNroCheque());
        }
        jl_nroCheque.setModel(modelo);
    }
    ...
    private void initComponents() {
        ...
        jl_nroCheque = new javax.swing.JList<>();
        ...
        jScrollPane2.setViewportView(jl_nroCheque);
    ...
    private javax.swing.JList<String> jl_nroCheque;
